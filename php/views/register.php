...
<div class="mt-5">
    ...
    <div class="login-form bg-white p-4 shadow-sm mx-auto rounded">
        <form class="validate-form" action="<?php echo CURRENT_URI; ?>" method="POST"  autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input id="nickname" type="text" name="nickname" class="form-control validate-target" require d maxlength='10' >
                <div class="invalid-feedback"></div>
            </div>
